...
from power_pptx.enum.shapes import PP_PLACEHOLDER, PROG_ID
...
from power_pptx.oxml.simpletypes import ST_Direction
...
if TYPE_CHECKING:
    ...
    from power_pptx.slide import Slide, SlideLayout
...
class _BaseGroupShapes(_BaseShapes):
    ...
    def add_ole_object(
        ...
        `prog_id` can be either a member of `power_pptx.enum.shapes.PROG_ID` or a str value like
